...
无价格字段按 (品类,品牌) 确定性合成、无商品名/品类为数字编码 → 按品类码词库确定性
合成中文可检索商品名(如 "耳机-9001"/品类"影音数码")——商城中文搜索/品类筛选/
漏斗分组因此可用(原 SKU-xxx 数字码商品名无法支撑任何自然语言检索),合成口径与价格同级如实记录——RFM/聚类/Agent 全链路零改动,
